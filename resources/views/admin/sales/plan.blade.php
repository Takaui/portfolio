            ...
            <div class= "container">
                <div class= "row">
                    <div class="col-md-8 mx-auto">
                        ...
                        <form action="{{action('Admin\SalesController@planSave')}}" method="post" >
                        <div>
                            <h2>テープタイプ使用者</h2>
                        ...
                        <a href="{{ action('Admin\SalesController@planDelete',['id' => $client->id]) }}" role="button" class="btn btn-primary">設定解除</a>
                        </div>
                    </div>
                </div>
            </div>    
